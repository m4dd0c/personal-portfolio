  ...
  return (
    <div className="bg-white dark:bg-gray-950 pb-5">
      ...
      <div className="flex flex-col justify-center align-center space-x-3">
        ...
        <small className="uppercase leading-loose font-mono text-center text-gray-50/50">
