...
const About = () => {
  return (
    <>
      <HrText>
        <p className="text-sky-500 dark:text-sky-400 top-0 -left-[--gutter-width] origin-bottom-right text-left font-mono font-semibold text-sm tracking-widest uppercase max-2xl:mb-4 max-2xl:px-2 max-sm:px-4 sm:text-xs 2xl:absolute 2xl:-translate-x-full 2xl:-translate-y-full 2xl:-rotate-90 2xl:text-right">
          About Me
        </p>
      </HrText>
      <HrText>
      ...
      <br />
      <HrText>
        <p className="max-w-(--breakpoint-md) px-2 text-lg/7 text-gray-600 max-sm:px-4 dark:text-gray-400">
